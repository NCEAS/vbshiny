...
- Report a bug or request a new feature in our [issue tracker](https://github.com/NCEAS/vbshiny/issues)
...
- add an [issue](https://github.com/NCEAS/vbshiny/issues) describing your planned changes, or add a comment to an existing issue;
- on GitHub, fork the [repository](https://github.com/NCEAS/vbshiny)
...
Development is managed through the git repository at https://github.com/NCEAS/vbshiny.  The repository is organized into several branches, each with a specific purpose.  
...
3. Releases can be downloaded from the [GitHub releases page](https://github.com/NCEAS/vbshiny/releases).
